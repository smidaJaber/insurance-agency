...
export type ViewMode = 'Home' | 'About' | 'Support' ;
...
export interface ProfileConfig{
	...
	activeId: string | "Tous"
}
export interface ProfileFournisseurConfig{
...
export interface SurrealistConfig {
	...
	activeTabProfileFournisseur: string | null;
	activeTabProfileClient: string | null;
	activeFournisseur: string | null;
...
export interface FactureDefinition {
	id: string,
